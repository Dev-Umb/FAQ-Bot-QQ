...
object Lucky {
    fun getDraw(sender: Member, things: Message?): String? {
        ...
        val num = Math.abs(sender.id.hashCode() and things.hashCode() xor key) %
                (AppConfig.getInstance().draws.size)
        return AppConfig.getInstance().draws[abs(num - 1)] +
